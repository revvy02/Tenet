...
function DynamicStoreClient.new(initial, reducers)
    ...
    self.loaded = self._cleaner:give(Slick.Signal.new())
    self.unloaded = self._cleaner:give(Slick.Signal.new())
...
function DynamicStoreClient:dispatch(key, reducer, ...)
...
function DynamicStoreClient:load(key, value)
...
function DynamicStoreClient:unload(key)
...
function DynamicStoreClient:destroy()
